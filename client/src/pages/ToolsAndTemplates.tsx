  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Download free project management templates and resources for small businesses and charities." />
      </Helmet>

      <Breadcrumb 
        items={[{ label: "Tools & Templates", path: "/tools-and-templates", isCurrent: true }]} 
      />

      <div className="bg-white dark:bg-neutral-800 py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="font-heading font-bold text-3xl md:text-4xl mb-4 text-center">Tools & Templates</h1>
              ...
              <>
                ...
                {filteredTemplates.length > 0 ? (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center">
                            ...
                            <h3 className="font-heading font-medium text-lg">{template.title}</h3>
                          </div>
                          <span className="text-sm text-neutral-500 dark:text-neutral-400">{template.category}</span>
                        </div>
                  ...
                  <div className="text-center py-10">
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400 mb-2">No templates found matching your criteria</p>
