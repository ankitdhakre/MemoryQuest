    ...
    <section className="bg-gradient-to-br from-primary-500 to-primary-700 dark:from-primary-700 dark:to-primary-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="font-heading font-bold text-4xl md:text-5xl mb-4">Project Management Made Simple</h1>
          <p className="text-lg md:text-xl mb-8">A comprehensive guide for SMEs and charities to deliver successful projects</p>
